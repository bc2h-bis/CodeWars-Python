...
# As your volume picks up that's been taking more of your time, and unfortunately lately you've been running into situations
# where you take an order but can't fulfill it.
...
def fillable(stock, merch, n):
    # verify merch in stock
    try:
        # retrived stock quantity of demanded item
        stock_qty = stock[merch]
        # compare stock level with demande
        result = stock_qty - n
        # return result
        return result >= 0
